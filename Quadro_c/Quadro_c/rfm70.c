/*
	...
	angepasst, dass man sie auf einem AVR und ohne zusдtzliche Libs von Arduino
	verwenden kann.
...
//{ (0x20|0x04), 0xB9, 0x9E, 0x86, 0x0B }, //library original
//{ (0x20|0x04), 0xF9, 0x9E, 0x86, 0x0B }, //b9? f9?
//{ (0x20|0x04), 0xD9, 0x9E, 0x86, 0x0B }, //0xD99E860B(High Power) 
//{ (0x20|0x04), 0xD9, 0x9E, 0x86, 0x21 }, //For single carrier mode:0xD99E8621
  { (0x20|0x04), 0xD9, 0x96, 0x82, 0x1B }, //rfm70-rfm73:0x1B8296D9
  { (0x20|0x05), 0x24, 0x06, 0x7F, 0xA6 },
//{ (0x20|0x05), 0x3C, 0x02, 0x7F, 0xA6 }, //from eess9
...
//{ (0x20|0x0D), 0x36, 0xB4, 0x80, 0x00 }
  { (0x20|0x0D), 0x46, 0xB4, 0x80, 0x00 } //rfm70-rfm73:0x46B48000
};
...
{
	selectBank(0);
	writeRegVal(0x20, 0x0D);
}

void powerUpMode (void)
{
	selectBank(0);
	writeRegVal(0x20, 0x0F);
}
